...
public class DataTypes {
    ...
    public static final PTableType<String, String> STRING_TO_STRING_TABLE_TYPE = Avros.keyValueTableOf(STRING_TYPE,
            STRING_TYPE);
    public static final PTableType<Pair<String, String>, Double> PAIR_STRING_STRING_TO_DOUBLE_TABLE_TYPE = Avros
            .keyValueTableOf(PAIR_STRING_STRING_TYPE, DOUBLE_TYPE);
    public static final PTableType<String, Collection<Double>> STRING_TO_DOUBLE_COLLECTION_TABLE_TYPE = Avros
            .keyValueTableOf(STRING_TYPE, DOUBLE_COLLECTION_TYPE);
